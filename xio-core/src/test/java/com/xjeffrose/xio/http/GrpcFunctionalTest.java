...
public class GrpcFunctionalTest extends Assert {
  ...
  public void testGrpcProxyRequest() throws Exception {
    ...
    ProxyRouteConfig proxyConfig = new ProxyRouteConfig(ConfigFactory.load().getConfig("xio.testProxyRoute"));
                    ...
                    return new PipelineRouter(
                        ImmutableMap.of(
                            ...
                            new ProxyRouteState(
                                ...
                                proxyConfig,
                                new ProxyHandler(
                                    factory, proxyConfig, new SocketAddressHelper(), appState.tracing()))));
                  }
                });
