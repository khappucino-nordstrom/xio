...
public class ReverseProxyFunctionalTest extends Assert {
  ...
  static Application setupReverseProxy(ApplicationConfig appConfig, ProxyRouteConfig proxyConfig, XioTracing tracing) {
                    ...
                    new SmartHttpPipeline() {
                      ...
                      public ChannelHandler getApplicationRouter() {
                        return new PipelineRouter(
                            ImmutableMap.of(),
                            new ProxyHandler(factory, proxyConfig, new SocketAddressHelper(), tracing));
                      }
                    }))
        .build();
  }
  ...
  void setupFrontBack(boolean h2Front, boolean h2Back) throws Exception {
    ...
    reverseProxy = setupReverseProxy(appConfig, proxyConfig, new XioTracing(root.getConfig("xio.testProxyRoute")));
  }
